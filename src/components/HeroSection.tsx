...
export const HeroSection: React.FC = () => {
  ...
  return (
    <section className="w-[687px] h-[295px] shrink-0 absolute left-[311px] top-[299px] max-md:w-[calc(100%_-_40px)] max-md:h-auto max-md:left-5 max-md:top-[150px] max-sm:w-[calc(100%_-_32px)] max-sm:left-4 max-sm:top-[120px]">
      <h1 className="w-[687px] h-[226px] shrink-0 text-black text-[80px] font-[590] leading-[72px] absolute left-0 top-0 max-md:w-full max-md:text-5xl max-md:h-auto max-md:leading-[48px] max-sm:text-4xl max-sm:leading-[37.8px]">
        Your journey to effortless investing starts here
      </h1>
      ...
      <button 
        ...
        className="absolute left-0 top-[327px] max-md:top-[250px] max-sm:top-[270px]"
